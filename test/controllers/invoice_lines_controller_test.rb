...
class InvoiceLinesControllerTest < ActionController::TestCase
  ...
  test "should create invoice_line" do
    assert_difference('InvoiceLine.count') do
      post :create, invoice_line: { article_id: @invoice_line.article_id, invoice_header_id: @invoice_line.invoice_header_id, quantity: @invoice_line.quantity, unit_price: @invoice_line.unit_price }
    end
  ...
  test "should update invoice_line" do
    patch :update, id: @invoice_line, invoice_line: { article_id: @invoice_line.article_id, invoice_header_id: @invoice_line.invoice_header_id, quantity: @invoice_line.quantity, unit_price: @invoice_line.unit_price }
    assert_redirected_to invoice_line_path(assigns(:invoice_line))
  end
